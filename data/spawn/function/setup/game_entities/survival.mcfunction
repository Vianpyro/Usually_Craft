...
$summon minecraft:villager $(x).5 $(y) $(z).5 {Profession:0,NoAI:1b,Silent:1,Age:0,Rotation:[-90F,0F]}
...
$scoreboard players set @e[type=minecraft:interaction,x=$(x).5,y=$(y),z=$(z).5,distance=..1.5] go_to 2
