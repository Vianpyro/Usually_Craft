...
execute if score @s daily_reward_streak matches 90.. run advancement grant @s only main:daily_reward/consecutive_claims/level_5
execute if score @s daily_reward_streak matches 180.. run advancement grant @s only main:daily_reward/consecutive_claims/level_6
execute if score @s daily_reward_streak matches 270.. run advancement grant @s only main:daily_reward/consecutive_claims/level_7
execute if score @s daily_reward_streak matches 365.. run advancement grant @s only main:daily_reward/consecutive_claims/level_8
