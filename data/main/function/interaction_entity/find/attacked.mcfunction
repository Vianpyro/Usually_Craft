...
execute on attacker store result score interact_go_to buffer if entity @s[tag=this]
...
execute if score interact_go_to buffer matches 1 run data remove entity @s attack
