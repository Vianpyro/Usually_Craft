...
execute on target store result score interact_action buffer if entity @s[tag=this]
...
execute if score interact_action buffer matches 1 run data remove entity @s interaction
