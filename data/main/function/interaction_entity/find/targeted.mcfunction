...
execute on target store result score interact_go_to test if entity @s[tag=this]
...
execute if score interact_go_to test matches 1 run data remove entity @s interaction
