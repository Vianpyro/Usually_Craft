...
execute as @e[type=minecraft:interaction,tag=ground_coin_pouch_placing] at @r[predicate=spawn:in_spawn] run function easter_egg:spawn/coins_pouch/place with storage easter_egg:coins_pouch
