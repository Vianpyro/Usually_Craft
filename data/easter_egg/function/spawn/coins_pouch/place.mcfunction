$spreadplayers ~ ~ 0 300 under $(max_height) false @s
execute at @s unless block ~ ~-.5 ~ #main:coin_valid_spawn run return run function easter_egg:spawn/coins_pouch/place with storage easter_egg:coins_pouch
