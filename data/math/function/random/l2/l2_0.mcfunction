$execute if score @s $(score) matches 1..65 run return run function math:random/l1/l1_0 {"score":"$(score)"}
$execute if score @s $(score) matches 65..129 run return run function math:random/l1/l1_1 {"score":"$(score)"}
$execute if score @s $(score) matches 129..193 run return run function math:random/l1/l1_2 {"score":"$(score)"}
$execute if score @s $(score) matches 193..257 run return run function math:random/l1/l1_3 {"score":"$(score)"}
